#!/bin/bash
#SBATCH --job-name=polars_benchmark_8c60g_scale100
...
#SBATCH --output=polars_benchmark_8c60g_scale100_%x_%j.out
#SBATCH --error=polars_benchmark_8c60g_scale100_%x_%j.err
