#!/bin/bash
#SBATCH --job-name=polars_benchmark_8c60g_scale01
...
#SBATCH --output=polars_benchmark_8c60g_scale01_%x_%j.out
#SBATCH --error=polars_benchmark_8c60g_scale01_%x_%j.err
