#!/bin/bash
#SBATCH --job-name=polars_benchmark_1c60g_scale100
...
export escala=100.0
export rep=50
export imagem="polars-benchmark-1c60g"
...
export DUCKDB_EXTERNAL_THREADS=1
export DUCKDB_ASYNC_IO_THREADS=1
export SPARK_EXECUTOR_CORES=1
export SPARK_EXECUTOR_INSTANCES=1
export SPARK_DRIVER_CORES=1
export SPARK_DEFAULT_PARALLELISM=8  # 1 core * 8 partitions per core
